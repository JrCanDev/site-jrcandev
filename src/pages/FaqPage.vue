  ...
  <div class="corps corps-faq" @click="isDropdownOpen = false">
    <div class="questions">
      ...
      <ul>
        ...
        <li><a href="#changement-mot-de-passe">Changer mon mot de passe</a></li>
        <li><a href="#mise_en_ligne">Mettre mon site en ligne</a></li>
        <li><a href="#carac_accentués">Les caractères accentués ne s'affichent pas bien</a></li>
        <li><a href="#acces_bdd">Accéder à une base de données sur des sites dynamiques</a></li>
        <li><a href="#wordhtml">Créer une page web sans connaître HTML</a></li>
      </ul>
    </div>
